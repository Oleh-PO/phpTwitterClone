<div class="profile">
	<div class="userFlex">
		...
		<h2><?php echo $this->getUserName; ?></h2>
	</div>
	<div class="bio">
		<div id="bio" method="POST">
			<textarea disabled name="bio" class="edit"><?php echo $this->getBio(); ?></textarea>
			<button style="display: none;" onclick="editRecuest(bio)">confirm</button>
		</div>
		<?php if ($this->userId === $this->getUserId): ?> <!-- if user is owner add button that allows to edit bio -->
